...
<html lang="en">
  ...
  <?php
    ...
    $id = $_GET['id'];
    $data = mysqli_query($koneksi, "select * from site where id='$id'");
    ...
    <form method="POST" action="input.php">
      <fieldset>
        ...
        <label for="user_id">NIK: <input id="user_id" name="user_id" type="text" required/></label>
      ...
      <fieldset>
        ...
        <label for="tempat_wisata"><input id="tempat_wisata" type="radio" name="tempat_wisata" class="inline" /> Paket 1 Dieng</label>
        <label for="tempat_wisata"><input id="tempat_wisata" type="radio" name="tempat_wisata" class="inline" /> Paket 2 Magelang</label>
        <label for="tempat_wisata"><input id="tempat_wisata" type="radio" name="tempat_wisata" class="inline" /> Paket 3 Karimun Jawa</label>
        <label for="tempat_wisata"><input id="tempat_wisata" type="radio" name="tempat_wisata" class="inline" /> Paket 4 Semarang</label>
